...
///////////////////////////////////////////////////////////////////////
      /*
       if(data.child("d").getValue().toString().equals("28") && item.toString().equals("Today")) {
                                 ...
                                 databasereference.child("Activity").orderByChild("idBudget").equalTo(idbudget).addListenerForSingleValueEvent(new ValueEventListener() {
                                     ...
                                     public void onDataChange(@NonNull  DataSnapshot snapshot) {
                                         if(snapshot.exists()){
                                             ...
                                             int some=0;
                                                     for (DataSnapshot data: snapshot.getChildren()) {
                                                        // Log.i("7222",data.child("user").getValue().toString());
                                                    // if(data.child("user").getValue().toString().equals("said")){
